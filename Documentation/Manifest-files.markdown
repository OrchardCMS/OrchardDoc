...
Dependencies       | A comma-separated list of the application `Id` values of all features that the specified feature depends on. Please note that Dependencies are **case sensitive**. 
