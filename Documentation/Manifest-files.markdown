...
**AntiForgery**    | <p>*Optional*</p><p>Possible values are `enabled` or `disabled`. Defaults to **disabled**.</p><p>A value that indicates whether request validation is enabled for a module.</p>
